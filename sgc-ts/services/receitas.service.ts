...
export const getReceitas = (
  params: ListParams
): Promise<PaginatedApiResponse<ReceitaDto[]>> => {
 ...
 */
export const createReceita = (
  data: CriarReceitaDto
): Promise<ApiResponse<ReceitaDto>> => {
  return apiClient.post("/receitas", data, {
 ...
 */
export const updateReceita = (
  id: string,
  data: AtualizarReceitaDto
): Promise<ApiResponse<ReceitaDto>> => {
  return apiClient.put(`/receitas/${id}`, data, {
...
export const deleteReceita = (id: string): Promise<ApiResponse<void>> => {
  return apiClient.delete(`/receitas/${id}`, {
